...
<?= $this->partial('meta') ?>
<body>
  <!--[if lte IE 8]><div class="alert_-danger">Your browser is <em>ancient!</em> <a href="http://browsehappy.com/" target="_blank">Upgrade to a modern browser</a> to experience this site.</div><![endif]-->
